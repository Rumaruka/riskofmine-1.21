package com.rumaruka.riskofmine.ntw.cmd.barrier;
...
public class BarrierAddCommand {

    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        LiteralCommandNode<CommandSourceStack> literalCommandNode = dispatcher.register(Commands.literal("barrier").requires((p_198442_0_) -> {
        ...
        dispatcher.register(Commands.literal("rom_barrier").requires((p_198441_0_) -> {
