...
import com.rumaruka.riskofmine.ntw.cmd.timer.TimerAddCommand;
import com.rumaruka.riskofmine.ntw.cmd.timer.TimerResetCommand;
import com.rumaruka.riskofmine.ntw.cmd.timer.TimerSetCommand;
...
public class ROMCommand {
    ...
    public static void onRegisterCommandEvent(RegisterCommandsEvent event) {
        ...
        TimerAddCommand.register(dispatcher);
        TimerSetCommand.register(dispatcher);
        TimerResetCommand.register(dispatcher);
