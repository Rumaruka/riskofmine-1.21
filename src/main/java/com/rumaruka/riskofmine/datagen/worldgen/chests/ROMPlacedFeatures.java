...
public class ROMPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, OVER_CHEST_GEN, overholder, ROMChestGen.commonOrePlacements(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(240), VerticalAnchor.absolute(-64))));
        register(context, NETHER_CHEST_GEN, netherholder, ROMChestGen.netherOrePlacements(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(200), VerticalAnchor.absolute(-64))));
        register(context, END_CHEST_GEN, endholder, ROMChestGen.endOrePlacements(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(200), VerticalAnchor.absolute(-64))));
    }
