...
public class ArtificerOverlayRender {
    ...
    private static final ResourceLocation DOUBLE_TAP_IMG = rl("textures/gui/skills/artificer/double_tap.png");
    private static final ResourceLocation SUPPRESSIVE_FIRE_IMG = rl("textures/gui/skills/artificer/suppressive_fire.png");
    private static final ResourceLocation PHASE_ROUND_IMG = rl("textures/gui/skills/artificer/phase_round.png");
    private static final ResourceLocation TACTICAL_DIVE_IMG = rl("textures/gui/skills/artificer/tactical_dive.png");
    ...
    private static void renderDoubleTapSkill(GuiGraphics gui) {
        ...
        FlameBolt doubleTap = ROMSkills.FLAME_BOLT;
        if (mc.getWindow().isFullscreen()) {
            ...
            if (!doubleTap.isCooldown()) {
                String toDisplay = String.valueOf(getFlameBoltDisplay(doubleTap));
